...
# Form implementation generated from reading ui file 'D:\kep\aid1803\microblog\microblog\page\h.ui'
#
...
"color: rgb(0, 0, 0);")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/imgs/imgs/white_information.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.me_.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/imgs/imgs/white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.search.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/imgs/imgs/white_search.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/imgs/imgs/black_house.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/imgs/imgs/plus_sign.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
